...
export const BuildNixMultiArchJobInputs = defineInputs({
  ...
  nix_target_amd64: {
    description:
      "Nix flake build target for amd64 (e.g. coreutils-amd64)" as const,
  },
  nix_target_arm64: {
    description:
      "Nix flake build target for arm64 (e.g. coreutils-arm64)" as const,
  },
  amd64_runner_tag: {
  ...
  version: {
    ...
    description:
      "Version/ref of the devguard-ci-component templates to use" as const,
  },
        ...
        include: [
          ...
          },
          {
            ...
            inputs: {
              ...
              dependencies: [
                `devguard:container_scanning${inputValues.job_suffix}`,
              ],
            },
          },
        ],
        ...
        include: [
          ...
          },
          {
            ...
            inputs: {
              ...
              needs: [
                `collect_child_pipeline_artifacts${inputValues.job_suffix}`,
              ],
              dependencies: [
                `collect_child_pipeline_artifacts${inputValues.job_suffix}`,
              ],
          ...
          },
          {
            ...
            inputs: {
              ...
              job_suffix: inputValues.job_suffix,
              needs: [
                `devguard:create_manifest_multi_arch${inputValues.job_suffix}`,
              ],
              dependencies: [
                `devguard:create_manifest_multi_arch${inputValues.job_suffix}`,
              ],
