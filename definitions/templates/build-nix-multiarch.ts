...
export const BuildNixMultiArchBuildImageTemplate = defineJob(BuildNixMultiArchJobInputs, (inputValues) => ({
...
export const BuildNixMultiArchCreateManifestTemplate = defineJob(BuildNixMultiArchJobInputs, (inputValues) => ({
    ...
    job: {
        ...
        trigger: {
            ...
            include: [
                {
                    remote: "https://gitlab.opencode.de/oci-community/tools/container-hardening-work-bench/-/raw/main/templates/collect-child-pipeline-artifacts.yml",
                    inputs: {
                        stage: "build",
                        job_suffix: inputValues.job_suffix,
